...
class TextBundleItem(
    ...
    init {
        ...
        if (!dreifa.app.fileBundle.BundleItem.Companion.validPathPattern.matches(path)) throw RuntimeException("$path contains invalid characters")
    ...
    override fun equals(other: Any?): Boolean {
        return if (other is dreifa.app.fileBundle.TextBundleItem) {
    ...
    companion object {
        ...
        fun fromFile(file: File, path: String, isExecutable: Boolean = false): dreifa.app.fileBundle.TextBundleItem {
...
class BinaryBundleItem(
    ...
    companion object {
        ...
        fun fromFile(file: File, path: String, isExecutable: Boolean = false): dreifa.app.fileBundle.BinaryBundleItem {
